...
"}")
        ...
        self.horizontalLayout.setContentsMargins(-1, 15, 15, -1)
        ...
        self.lbl_img.setPixmap(QtGui.QPixmap("../../Image/sprout.png"))
        ...
        self.layout_button.setContentsMargins(40, 10, 40, 20)
